...
class AirLoopBioreactor1State(IsolationState):
    ...
    def activate_state(self):
        return Routine(steps=[
            RoutineStep(SetRotaryValveFromAirLoopActionSet('bioreactor1'), then_wait_n_sec=0),
            RoutineStep(SetRotaryValveToAirLoopActionSet('bioreactor1'), then_wait_n_sec=0),
        ])
