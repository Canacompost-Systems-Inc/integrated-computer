...
class MoveCompostFromBioreactor2ToShredderStorageRoutine(Routine):
    ...
    def __init__(self):
        ...
        super().__init__(
            steps=[
                ...
                RoutineStep(SwitchAirHammerActionSet('bioreactor2', 'open'), then_wait_n_sec=1),
                RoutineStep(SwitchAirHammerActionSet('bioreactor2', 'close'), then_wait_n_sec=0),
            ...
            must_run_in_state=CompostLoopBioreactor2State,
